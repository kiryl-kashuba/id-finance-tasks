...
public class UpdateUserAccount implements ReactorDataFetcher<Long> {

  private final UserAccountRepository userAccountRepository;
  private final ObjectMapper objectMapper;

  public UpdateUserAccount(UserAccountRepository userAccountRepository,
  ...
  public Mono<Long> async(@NotNull DataFetchingEnvironment dataFetchingEnvironment) {
    return userAccountRepository.update(objectMapper.convertValue(dataFetchingEnvironment.getArgument("userAccount"),
